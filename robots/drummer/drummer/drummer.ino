...
void setup()
{
  ...
  for (int i = 0; i < 54; i++) {
    if (i < LED_COUNT_R) right_ring.setPixelColor(i, 255, 255, 255);
    if (i < LED_COUNT_L) left_ring.setPixelColor(i, 255, 255, 255);
    if (i < LED_COUNT_K) kick_ring.setPixelColor(i, 255, 255, 255);
  }
